...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Nov-2022 às 12:58
...
--
-- Estrutura da tabela `tb_médicos`
--

CREATE TABLE `tb_médicos` (
  `id_médico` int(20) NOT NULL,
  `nome do médico` varchar(100) NOT NULL,
  `especialidade` varchar(50) NOT NULL,
  `CRM` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `tb_médicos`
--

INSERT INTO `tb_médicos` (`id_médico`, `nome do médico`, `especialidade`, `CRM`) VALUES
(1, '\r\nLucca Luiz da Mata\r\n', 'Cardiologia', '654321'),
(2, '\r\nSarah Renata\r\n', 'Cardiologia', '454330'),
(3, '\r\n Luís Porto\r\n', 'Oftalmologia', '254320'),
...
INSERT INTO `tb_pacientes` (`id_paciente`, `Nome do paciente`, `Idade`, `Gênero`, `Endereço`, `Cep`, `Bairro`, `Celular`, `Estado civil`, `RG`, `CPF`, `N  cartão do sus`) VALUES
...
--
-- Índices para tabela `tb_médicos`
--
ALTER TABLE `tb_médicos`
...
--
-- AUTO_INCREMENT de tabela `tb_médicos`
--
ALTER TABLE `tb_médicos`
